...
def test_streaming():
    ...
    for test in test_queries:
        ...
        # Skip user input during automated testing
        # In a real interactive session, this would prompt for continuation
        if test != test_queries[-1]:
            # For automated testing, just continue to next test
            continue
